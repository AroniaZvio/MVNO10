    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-slate-600">Просмотрите доступные тарифы для ваших потребностей</p>
        </div>
        ...
        {connectedPlan && (
          <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="font-medium text-green-800">Ваш текущий тариф: {connectedPlan.planName}</div>
                  ...
                  <div className="p-6">
                    ...
                    {isConnected ? (
                      ...
                      <div className="mt-6 p-3 bg-slate-100 text-slate-600 rounded-lg text-center text-sm font-medium">
                        ℹ️ Для подключения войдите в личный кабинет
                      </div>
                    )}
                  </div>
                </div>
